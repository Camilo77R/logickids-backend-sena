...
VALUES
  ('logro_memoria', 'Maestro de la memoria', 'Completaste una actividad de memoria con buena precisión.', 'memoria_main', 'module', 'memoria', 'memoria_main', 1, '{"accuracy_gte":70}'::jsonb, 10, true),
  ...
  ('logro_logica', 'Pensador lógico', 'Resolviste un reto de lógica con buen resultado.', 'logica_main', 'module', 'logica', 'logica_main', 1, '{"accuracy_gte":70}'::jsonb, 30, true),
  ...
  ('logro_atencion', 'Ojo atento', 'Demostraste concentración durante la actividad.', 'atencion_main', 'module', 'atencion', 'atencion_main', 1, '{"accuracy_gte":70}'::jsonb, 50, true),
  ('primer_logro', 'Primer logro', 'Desbloqueaste tu primer logro.', 'general_star', 'global', NULL, 'general_star', 1, '{}'::jsonb, 60, true),
  ('precision_perfecta', 'Precisión perfecta', 'Lograste 100% de precisión en una sesión.', 'precision_main', 'global', NULL, 'precision_main', 2, '{"accuracy_eq":100}'::jsonb, 70, true),
  ('explorador', 'Explorador de aventuras', 'Jugaste al menos una vez los 5 módulos.', 'explorador_main', 'global', NULL, 'explorador_main', 3, '{"modules_played":5}'::jsonb, 80, true),
